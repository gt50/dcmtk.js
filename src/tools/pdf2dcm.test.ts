...
beforeEach(() => {
    vi.clearAllMocks();
    mockedResolveBinary.mockReturnValue({ ok: true, value: '/usr/local/bin/pdf2dcm' });
...
describe('pdf2dcm', () => {
    ...
    describe('result handling', () => {
        it('returns outputPath on success', async () => {
            const result = await pdf2dcm('/input.pdf', '/output.dcm');
